...
set_photo_button.grid(row=9, column=4, columnspan=n_col, padx=5, pady=5)
...
photo_info_label.grid(row=11, column=4, columnspan=n_col, padx=5, pady=5)

opt_text_box = tk.Text(root, height=10, width=170)
opt_text_box.grid(row=12, column=0, columnspan=n_col, padx=5, pady=5, sticky='nsew')
